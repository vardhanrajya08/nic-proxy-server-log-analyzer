<?php
    ...
    // Query to retrieve destination and count of 'tcp_denied' occurrences
    $query = "SELECT destination, COUNT(*) AS tcp_denied_count FROM logs WHERE action = 'TCP_DENIED/407' GROUP BY destination";
    ...
    if ($result->num_rows > 0) {
        // Define arrays for bar graph, pie chart, line graph, and scatter plot data
        $barXArray = array();
        $barYArray = array();
        $pieLabels = array();
        $pieValues = array();
...
<body>
    ...
    <script>
        ...
        var barLayout = {
            title: "Destination TCP Denied Statistics (Bar Graph)",
        ...
        var pieLayout = {
            title: "Destination TCP Denied Statistics (Pie Chart)",
        };
        ...
        var lineLayout = {
            title: "Destination TCP Denied Statistics (Line Graph)",
            xaxis: { title: "Destination" },
            yaxis: { title: "TCP Denied Count" }
        };
        ...
        var scatterLayout = {
            title: "Destination TCP Denied Statistics (Scatter Plot)",
            xaxis: { title: "Destination" },
            yaxis: { title: "TCP Denied Count" }
        };
